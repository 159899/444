...
class MainWindow(QTabWidget):
    def __init__(self):
        ...
        self.setWindowTitle('基于深度学习(Cnn)的垃圾分类系统')
        self.model = tf.keras.models.load_model("models/mobilenet_245_epoch30.h5")  #
        self.to_predict_name = "images/welcome.png"
    ...
    def initUI(self):
        ...
        img_title = QLabel("欢迎使用深度学习垃圾分类软件")
        ...
        label_super = QLabel('<a href="null">作者：丹成学长</a>')
